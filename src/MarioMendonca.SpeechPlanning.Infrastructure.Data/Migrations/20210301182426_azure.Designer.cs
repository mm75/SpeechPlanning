...
namespace MarioMendonca.SpeechPlanning.Infrastructure.Data.Migrations
{
    ...
    [Migration("20210301182426_azure")]
    partial class azure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarioMendonca.SpeechPlanning.Domain.Models.Programacao", b =>
                {
                    b.HasOne("MarioMendonca.SpeechPlanning.Domain.Models.Cantico", "Cantico")
                        .WithMany()
                        .HasForeignKey("CanticoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("MarioMendonca.SpeechPlanning.Domain.Models.Esboco", "Esboco")
                        .WithMany()
                        .HasForeignKey("EsbocoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MarioMendonca.SpeechPlanning.Domain.Models.Orador", "Orador")
                        .WithMany()
